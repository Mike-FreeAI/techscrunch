...
{#if step === 'password'}
	...
	<form class="form u-margin-block-start-64" on:submit|preventDefault={onSubmitPassword}>
		<ul class="form-list">
			<li class="form-item">
				<input
					bind:value={password}
...
{:else}
	...
	<form class="form u-margin-block-start-64" on:submit|preventDefault={onSubmitEmail}>
		<ul class="form-list">
			<li class="form-item">
				<input
					bind:value={email}
		...
		<a href="/auth/register">
			<button type="button" class="button-reverse u-margin-block-start-24 u-width-full-line">
