...
<article class="main-article u-margin-block-start-32">
    ...
    <button class="share-links-x-button">
      ...
      <svg class="share-links-x-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#c00d53cc" height="35%" width="35%" version="1.1" id="Capa_1" viewBox="0 0 460.775 460.775" xml:space="preserve">
      <path d="M285.08,230.397L456.218,59.27c6.076-6.077,6.076-15.911,0-21.986L423.511,4.565c-2.913-2.911-6.866-4.55-10.992-4.55  c-4.127,0-8.08,1.639-10.993,4.55l-171.138,171.14L59.25,4.565c-2.913-2.911-6.866-4.55-10.993-4.55  c-4.126,0-8.08,1.639-10.992,4.55L4.558,37.284c-6.077,6.075-6.077,15.909,0,21.986l171.138,171.128L4.575,401.505  c-6.074,6.077-6.074,15.911,0,21.986l32.709,32.719c2.911,2.911,6.865,4.55,10.992,4.55c4.127,0,8.08-1.639,10.994-4.55  l171.117-171.12l171.118,171.12c2.913,2.911,6.866,4.55,10.993,4.55c4.128,0,8.081-1.639,10.992-4.55l32.709-32.719  c6.074-6.075,6.074-15.909,0-21.986L285.08,230.397z"/>
      </svg>

      <svg class="share-links-x-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" xmlns:bx="https://boxy-svg.com" height="35%" width="35%">
        <defs>
          <bx:grid x="0" y="0" width="71.301" height="71.369"/>
        </defs>
        <g>
          <rect x="356.505" y="356.845" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(213, 97, 135);"/>
          <rect x="427.806" y="428.214" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(220, 121, 154);"/>
          <rect width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(172, 13, 75);"/>
          <rect x="142.602" y="142.738" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(207, 74, 119);"/>
          <rect x="213.903" y="214.107" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(213, 97, 135);"/>
          <rect width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(172, 13, 75);" x="71.301" y="71.369"/>
          <rect x="285.204" y="285.476" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(213, 97, 135);"/>
          <rect x="285.204" y="142.738" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(213, 97, 135);"/>
          <rect x="356.505" y="71.369" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(213, 97, 135);"/>
          <rect x="427.806" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(213, 97, 135);"/>
        </g>
        <rect y="428.214" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(213, 97, 135);"/>
        <rect x="71.301" y="356.845" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(213, 97, 135);"/>
        <rect x="142.602" width="71.301" height="71.369" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(213, 97, 135);" y="285.476"/>
      </svg>
		...
		<ul class="share-links-list">
			<li class="share-links-item">
				<a
					href={`https://twitter.com/intent/tweet?url=https://techscrunch.dev/article/${
						data.article.$id
					}&text=${encodeURIComponent(data.article.title)}&via=techscrunch"`}
					target="_blank"
			...
			<li class="share-links-item">
				<a
					href={`https://www.facebook.com/sharer.php?u=https://techscrunch.dev/article/${data.article.$id}`}
					target="_blank"
			...
			<li class="share-links-item">
				<a
					href={`https://www.linkedin.com/shareArticle?mini=true&url=https://techscrunch.dev/article/${
						data.article.$id
					}&title=${encodeURIComponent(data.article.title)}&summary=${
			...
			<li class="share-links-item">
				<a
					href={`https://www.reddit.com/submit?url=https://techscrunch.dev/article/${
						data.article.$id
					}&title=${encodeURIComponent(data.article.title)}`}
					target="_blank"
			...
			<li class="share-links-item">
				<a
					href={`mailto:?subject=${encodeURIComponent(
						...
						`Article: https://techscrunch.dev/article/${data.article.$id}`
					)}`}
					target="_blank"
